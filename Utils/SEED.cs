...
namespace SimReeferMiddlewareSystemWPF.Utils
{
    public class SEED : SymmetricAlgorithm
    {
        ...
        private static void EncRoundKeyUpdate0(ref uint[] K, int idx, ref uint A, ref uint B, ref uint C, ref uint D, uint KC)
        {
            ...
            num = A + C - KC;
            uint a = B + KC - D;
            K[idx] = SS0[GetB0(num)] ^ SS1[GetB1(num)] ^ SS2[GetB2(num)] ^ SS3[GetB3(num)];
            K[1 + idx] = SS0[GetB0(a)] ^ SS1[GetB1(a)] ^ SS2[GetB2(a)] ^ SS3[GetB3(a)];
        }
        ...
        {
            return (ROTL(dwS, 8) & 0xFF00FFu) | (ROTL(dwS, 24) & 0xFF00FF00u);
        }
        ...
        private static void SeedEncRoundKey(ref uint[] pRoundKey, byte[] UserKey)
        {
            ...
            uint kC = 1013904243u;
            uint kC2 = 2027808486u;
            uint kC3 = 4055616972u;
            uint kC4 = 3816266649u;
            uint kC5 = 3337566003u;
            uint kC6 = 2380164711u;
            uint kC7 = 465362127u;
            uint kC8 = 930724254u;
            uint kC9 = 1861448508u;
            uint kC10 = 3722897016u;
            uint kC11 = 3150826737u;
            uint kC12 = 2006686179u;
            uint kC13 = 4013372358u;
            uint kC14 = 3731777421u;
            uint kC15 = 3168587547u;
            uint dwS = BitConverter.ToUInt32(UserKey, 0);
            uint dwS2 = BitConverter.ToUInt32(UserKey, 4);
            uint dwS3 = BitConverter.ToUInt32(UserKey, 8);
            uint dwS4 = BitConverter.ToUInt32(UserKey, 12);
            dwS = EndianChange(dwS);
            dwS2 = EndianChange(dwS2);
            dwS3 = EndianChange(dwS3);
            dwS4 = EndianChange(dwS4);
            uint a = dwS + dwS3 - num;
            uint a2 = dwS2 - dwS4 + num;
            K[0] = SS0[GetB0(a)] ^ SS1[GetB1(a)] ^ SS2[GetB2(a)] ^ SS3[GetB3(a)];
            K[1] = SS0[GetB0(a2)] ^ SS1[GetB1(a2)] ^ SS2[GetB2(a2)] ^ SS3[GetB3(a2)];
            EncRoundKeyUpdate0(ref K, 2, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC);
            EncRoundKeyUpdate1(ref K, 4, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC2);
            EncRoundKeyUpdate0(ref K, 6, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC3);
            EncRoundKeyUpdate1(ref K, 8, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC4);
            EncRoundKeyUpdate0(ref K, 10, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC5);
            EncRoundKeyUpdate1(ref K, 12, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC6);
            EncRoundKeyUpdate0(ref K, 14, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC7);
            EncRoundKeyUpdate1(ref K, 16, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC8);
            EncRoundKeyUpdate0(ref K, 18, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC9);
            EncRoundKeyUpdate1(ref K, 20, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC10);
            EncRoundKeyUpdate0(ref K, 22, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC11);
            EncRoundKeyUpdate1(ref K, 24, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC12);
            EncRoundKeyUpdate0(ref K, 26, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC13);
            EncRoundKeyUpdate1(ref K, 28, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC14);
            EncRoundKeyUpdate0(ref K, 30, ref dwS, ref dwS2, ref dwS3, ref dwS4, kC15);
        }

        private static void SeedRound(ref uint L0, ref uint L1, uint R0, uint R1, uint[] K, int idx)
        {
            uint num = R0 ^ K[idx];
            uint num2 = R1 ^ K[1 + idx];
            num2 ^= num;
            num2 = SS0[GetB0(num2)] ^ SS1[GetB1(num2)] ^ SS2[GetB2(num2)] ^ SS3[GetB3(num2)];
            num += num2;
            num = SS0[GetB0(num)] ^ SS1[GetB1(num)] ^ SS2[GetB2(num)] ^ SS3[GetB3(num)];
            num2 += num;
            num2 = SS0[GetB0(num2)] ^ SS1[GetB1(num2)] ^ SS2[GetB2(num2)] ^ SS3[GetB3(num2)];
            num += num2;
            L0 ^= num;
        ...
        {
            uint dwS = BitConverter.ToUInt32(pData, 0);
            uint dwS2 = BitConverter.ToUInt32(pData, 4);
            uint dwS3 = BitConverter.ToUInt32(pData, 8);
            uint dwS4 = BitConverter.ToUInt32(pData, 12);
            dwS = EndianChange(dwS);
            dwS2 = EndianChange(dwS2);
            dwS3 = EndianChange(dwS3);
            dwS4 = EndianChange(dwS4);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 0);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 2);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 4);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 6);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 8);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 10);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 12);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 14);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 16);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 18);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 20);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 22);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 24);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 26);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 28);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 30);
            dwS = EndianChange(dwS);
            dwS2 = EndianChange(dwS2);
            dwS3 = EndianChange(dwS3);
            dwS4 = EndianChange(dwS4);
            Buffer.BlockCopy(BitConverter.GetBytes(dwS3), 0, pData, 0, 4);
            Buffer.BlockCopy(BitConverter.GetBytes(dwS4), 0, pData, 4, 4);
            Buffer.BlockCopy(BitConverter.GetBytes(dwS), 0, pData, 8, 4);
            Buffer.BlockCopy(BitConverter.GetBytes(dwS2), 0, pData, 12, 4);
        }
        ...
        private static void SeedDecryptBlock(ref byte[] pData, uint[] RoundKey)
        {
            ...
            dwS3 = EndianChange(dwS3);
            dwS4 = EndianChange(dwS4);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 30);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 28);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 26);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 24);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 22);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 20);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 18);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 16);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 14);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 12);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 10);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 8);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 6);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 4);
            SeedRound(ref dwS, ref dwS2, dwS3, dwS4, RoundKey, 2);
            SeedRound(ref dwS3, ref dwS4, dwS, dwS2, RoundKey, 0);
            dwS = EndianChange(dwS);
            dwS2 = EndianChange(dwS2);
            dwS3 = EndianChange(dwS3);
            dwS4 = EndianChange(dwS4);
        ...
        public string Dec(string s, string Key)
        {
            ...
            return Encoding.UTF8.GetString(Decrypt(data, bytes));
        }

        internal static byte[] Encrypt(byte[] Data, byte[] seedKey)
        {
            return Encrypt(Data, seedKey, cbcPad: true);
        }

        internal static byte[] Encrypt(byte[] Data, byte[] seedKey, bool cbcPad)
        {
            int num = Data.Length / 16 * 16;
            num = ((!cbcPad) ? ((num == 0) ? 16 : (num * 16)) : ((Data.Length + 16) / 16 * 16));
            int num2 = Data.Length;
            byte[] array = new byte[num];
            Buffer.BlockCopy(Data, 0, array, 0, num2);
            if (cbcPad)
            {
                int num3 = num - num2;
                if (num3 == 0)
            ...
            uint[] pRoundKey = new uint[32];
            SeedEncRoundKey(ref pRoundKey, seedKey);
            byte[] array2 = new byte[16];
            for (int j = 0; j < num; j += 16)
            {
                byte[] operand = new byte[16];
                Buffer.BlockCopy(array, j, operand, 0, 16);
                if (cbcPad)
                {
                    XorByte(ref operand, array2);
                }

                SeedEncryptBlock(ref operand, pRoundKey);
                Buffer.BlockCopy(operand, 0, array, j, 16);
                if (cbcPad)
                {
                    Buffer.BlockCopy(operand, 0, array2, 0, 16);
                }
            }
        ...
        {
            return Decrypt(Data, seedKey, cbcPad: true);
        }
        ...
        internal static byte[] Decrypt(byte[] Data, byte[] seedKey, bool cbcPad)
        {
            ...
            for (int i = 0; i < num; i += 16)
            {
                ...
                Buffer.BlockCopy(Data, i, pData, 0, 16);
                SeedDecryptBlock(ref pData, pRoundKey);
                if (cbcPad)
                {
                    XorByte(ref pData, array2);
                }

                Buffer.BlockCopy(pData, 0, array, i, 16);
                if (cbcPad)
                {
                    Buffer.BlockCopy(Data, i, array2, 0, 16);
                }
            }
            ...
            if (cbcPad)
            {
                ...
                if (num2 > 0 && num2 <= 16)
                {
                    int num3 = 0;
                    num3 = num - 1;
                    while (num3 > num - num2 && array[num3] == num2)
                    {
                        num3--;
                    }
                    ...
                    {
                        num -= num2;
                        Buffer.BlockCopy(array, 0, Data, 0, num);
                        array = new byte[num];
        ...
        {
            KeyGenerator.GenerateSEEDKey();
        }

        public override void GenerateKey()
        {
            KeyGenerator.GenerateSEEDIV();
        }
    }
}
