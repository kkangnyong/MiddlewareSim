...
namespace SimReeferMiddlewareSystemWPF.ViewModel.ProtocolVer.Ver10
{
    public class ProtocolViewModelVer10 : ViewModelBase
    {
        ...
        {
            get { return (ViewModelBase)App.Current.Services.GetService(typeof(DeviceInfoViewModelVer10)); }
        }

        public INotifyPropertyChanged? CurrentSetupInfoViewModel
        {
            get { return (ViewModelBase)App.Current.Services.GetService(typeof(SetupInfoViewModelVer10)); }
        }

        public INotifyPropertyChanged? CurrentDeviceBodyViewModel
        {
            get { return (ViewModelBase)App.Current.Services.GetService(typeof(DeviceBodyViewModelVer10)); }
        }

        public INotifyPropertyChanged? CurrentReeferBodyViewModel
        {
            get { return (ViewModelBase)App.Current.Services.GetService(typeof(ReeferBodyViewModelVer10)); }
        }

        public INotifyPropertyChanged? CurrentSensorBodyViewModel
        {
            get { return (ViewModelBase)App.Current.Services.GetService(typeof(SensorBodyViewModelVer10)); }
        }
        ...
        private static ProtocolViewModelVer10 _instance;
        public ProtocolViewModelVer10 Instance { get { if (_instance == null) _instance = new ProtocolViewModelVer10(); return _instance; } }
        ...
        public ProtocolViewModelVer10(IMessageBoxService messageBoxService, IModelDataService modelData,
